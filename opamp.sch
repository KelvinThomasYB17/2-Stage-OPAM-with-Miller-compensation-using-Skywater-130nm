...
model=pfet_01v8_lvt
spiceprefix=X}
C {sky130_fd_pr/pfet_01v8_lvt.sym} 1590 -270 0 1 {
name=M2
L=\{l_par\}
W=\{w_par\}
nf=1
...
C {ngspice_get_value.sym} 1090 -470 0 0 {name=r71 node=v(@M.X1.XM8.msky130_fd_pr__pfet_01v8[vgs])
descr="vsg= "}
C {ngspice_get_value.sym} 1520 -470 0 0 {name=r1 node=v(@M.X1.XM5.msky130_fd_pr__pfet_01v8[vgs])
descr="vsg= "}
C {ngspice_get_value.sym} 1810 -460 0 0 {name=r7 node=v(@M.X1.XM7.msky130_fd_pr__pfet_01v8[vgs])
descr="vsg= "}
C {ngspice_get_value.sym} 1570 -460 0 0 {name=r23 node=v(@M.X1.XM5.msky130_fd_pr__pfet_01v8[vdsat])
descr="vdsat= "}
C {ngspice_get_value.sym} 1210 -290 0 0 {name=r81 node=v(@M.X1.XM1.msky130_fd_pr__pfet_01v8_lvt[vth])
descr="vth= "}
C {ngspice_get_value.sym} 1220 -330 0 0 {name=r24 node=v(@M.X1.XM1.msky130_fd_pr__pfet_01v8_lvt[vgs])
descr="vsg= "}
C {ngspice_get_expr.sym} 1140 -300 0 0 {name=r26 node="[format %.4g [expr 1 / [ngspice::get_node \{@M.X1.XM1.msky130_fd_pr__pfet_01v8_lvt[gds]\}] ] ]"
descr="ro="}
C {ngspice_get_value.sym} 1200 -160 0 0 {name=r28 node=@M.X1.XM3.msky130_fd_pr__nfet_01v8[gds]
descr="gds= "}
C {ngspice_get_value.sym} 1790 -90 0 0 {name=r27 node=@M.X1.XM6.msky130_fd_pr__nfet_01v8[gds]
descr="gds= "}
C {ngspice_get_value.sym} 1790 -400 0 0 {name=r29 node=@M.X1.XM7.msky130_fd_pr__pfet_01v8[gds]
descr="gds= "}
C {ngspice_get_expr.sym} 1200 -110 0 0 {name=r30 node="[format %.4g [expr 1 / [ngspice::get_node \{@M.X1.XM3.msky130_fd_pr__nfet_01v8[gds]\}] ] ]"
descr="ro="}
C {ngspice_get_expr.sym} 1940 -80 0 0 {name=r31 node="[format %.4g [expr 1 / [ngspice::get_node \{@M.X1.XM6.msky130_fd_pr__nfet_01v8[gds]\}] ] ]"
descr="ro="}
C {ngspice_get_expr.sym} 1790 -360 0 0 {name=r32 node="[format %.4g [expr 1 / [ngspice::get_node \{@M.X1.XM7.msky130_fd_pr__pfet_01v8[gds]\}] ] ]"
descr="ro="}
C {ngspice_get_value.sym} 1740 -460 0 0 {name=r33 node=v(@M.X1.XM7.msky130_fd_pr__pfet_01v8[vdsat])
descr="vdsat= "}
C {ngspice_get_value.sym} 1830 -120 0 0 {name=r34 node=v(@M.X1.XM6.msky130_fd_pr__nfet_01v8[vdsat])
descr="vdsat= "}
C {ngspice_get_value.sym} 1590 -430 0 0 {name=r35 node=v(@M.X1.XM5.msky130_fd_pr__pfet_01v8[vth])
descr="vth= "}
C {ngspice_get_value.sym} 1830 -10 0 0 {name=r36 node=@M.X1.XM6.msky130_fd_pr__nfet_01v8[cgs]
descr="cgs= "}
C {ngspice_get_value.sym} 1630 -310 0 0 {name=r37 node=@M.X1.XM2.msky130_fd_pr__pfet_01v8[cgg]
descr="cgg= "}
